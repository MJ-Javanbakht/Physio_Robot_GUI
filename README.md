# FUM-Physio
> Physiotherapy helps with increase in muscle power, mostly for athletes, or rehabilitation of patients. Modern physiotherapy upgrades conventional protocols in order to increase their capabilities and precision by integrating robotic technology into the treatment process. FUM-Physio is a knee rehabilitation and evaluation robot which can perform all conventional, manually-performed tasks and then some. It includes the passive, isometric, isotonic and isokinetic (ECC-CON, ECC-ECC, CON-ECC, CON-CON) algorithms rivaling its global counterparts in this respect. The in-demand isokinetic algorithm can only be performed by physiotherapy robotic devices, which demonstrates the significance of treatment modernization.

> # For more information visit: http://www.fum-care.com/index.php/research-topics/medical-robots/fum-physio
